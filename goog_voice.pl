...
my $username = "YOUR_GMAIL\@gmail.com"; # dont forget to escape @ symbols
my $password = "TYPE_YOUR_PASSWORD";
my $default_number = "YOUR_GVOICE_NUMBER";
