...
note three =  new note(0,0,64);

note four =  new note(2,0,32);

note five =  new note(4,0,16);

note six =  new note(5,0,64);

note seven =  new note(7,0,32);

note eight =  new note(9,1,16);

scale test = new scale(new ArrayList<note>() {{
add(one);
add(two);
add(three);
add(four);
...
public void run() throws Exception {
	test = new scale(new ArrayList<note>() {{
add(one);
add(two);
add(three);}});
