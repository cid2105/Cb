...
chord t1 = new chord(new ArrayList<note>() {{
add( new note(0,0,16));}}, 16);

chord t2 = new chord(new ArrayList<note>() {{
add( new note(7,0,16));}}, 16);

chord t3 = new chord(new ArrayList<note>() {{
add( new note(9,0,16));}}, 16);

chord t4 = new chord(new ArrayList<note>() {{
add( new note(5,0,16));}}, 16);

chord t5 = new chord(new ArrayList<note>() {{
add( new note(4,0,16));}}, 16);

chord t6 = new chord(new ArrayList<note>() {{
add( new note(2,0,16));}}, 16);

chord t10 = new chord(new ArrayList<note>() {{
add( new note(7,0,32));}}, 32);

chord t11 = new chord(new ArrayList<note>() {{
add( new note(0,0,32));}}, 32);

chord t12 = new chord(new ArrayList<note>() {{
add( new note(2,0,32));}}, 32);
