...
n1 =  new note(3,1,sixteenth);

n2 =  new note(4,1,sixteenth);

n3 =  new note(6,1,eighth);

n4 =  new note(11,1,eighth);

n5 =  new note(3,1,sixteenth);

n6 =  new note(4,1,sixteenth);

n7 =  new note(6,1,sixteenth);

n8 =  new note(11,1,sixteenth);

n9 =  new note(1,2,sixteenth);

n10 =  new note(3,2,sixteenth);

n11 =  new note(1,2,sixteenth);

n12 =  new note(10,1,sixteenth);

n13 =  new note(11,1,eighth);

seq1 = new stanza(new ArrayList<chord>() {{
add(chordOfNote(n1));
add(chordOfNote(n2));
add(chordOfNote(n3));
add(chordOfNote(n4));
...
n14 =  new note(11,1,eighth);

n15 =  new note(6,1,sixteenth);

n16 =  new note(4,1,sixteenth);

n17 =  new note(6,1,eighth);

n18 =  new note(11,1,eighth);

n19 =  new note(3,1,sixteenth);

n20 =  new note(4,1,sixteenth);

n21 =  new note(6,1,sixteenth);

n22 =  new note(11,1,sixteenth);

n23 =  new note(1,2,sixteenth);

n24 =  new note(3,2,sixteenth);

n25 =  new note(1,2,sixteenth);

n26 =  new note(11,1,sixteenth);

seq2 = new stanza(new ArrayList<chord>() {{
add(chordOfNote(n14));
add(chordOfNote(n15));
add(chordOfNote(n16));
add(chordOfNote(n17));
...
n27 =  new note(6,2,eighth);

n28 =  new note(8,2,eighth);

n29 =  new note(3,2,sixteenth);

n30 =  new note(3,2,eighth);

n31 =  new note(11,1,sixteenth);

n32 =  new note(1,2,sixteenth);

n33 =  new note(11,1,sixteenth);

n34 =  new note(11,1,eighth);

n35 =  new note(6,1,eighth);

n36 =  new note(11,1,eighth);

seq3 = new stanza(new ArrayList<chord>() {{
add(chordOfNote(n27));
add(chordOfNote(n28));
add(chordOfNote(n29));
add(chordOfNote(n30));
...
n37 =  new note(2,2,eighth);

n38 =  new note(2,2,sixteenth);

n39 =  new note(1,2,sixteenth);

n40 =  new note(11,1,eighth);

n41 =  new note(3,1,sixteenth);

n42 =  new note(6,2,sixteenth);

n43 =  new note(8,2,sixteenth);

n44 =  new note(2,2,sixteenth);

n45 =  new note(6,2,sixteenth);

n46 =  new note(11,1,sixteenth);

n47 =  new note(1,2,sixteenth);

n48 =  new note(2,1,sixteenth);

n49 =  new note(1,2,sixteenth);

n50 =  new note(11,1,sixteenth);

seq4 = new stanza(new ArrayList<chord>() {{
add(chordOfNote(n37));
add(chordOfNote(n38));
add(chordOfNote(n39));
add(chordOfNote(n40));
...
n51 =  new note(0,2,sixteenth);

n52 =  new note(6,2,sixteenth);

n53 =  new note(8,2,eighth);

n54 =  new note(2,2,eighth);

n55 =  new note(1,2,sixteenth);

n56 =  new note(11,1,sixteenth);

n57 =  new note(1,2,eighth);

n58 =  new note(11,1,sixteenth);

n59 =  new note(11,1,sixteenth);

n60 =  new note(6,1,eighth);

n61 =  new note(11,1,eighth);

seq5 = new stanza(new ArrayList<chord>() {{
add(chordOfNote(n51));
add(chordOfNote(n52));
add(chordOfNote(n53));
add(chordOfNote(n54));
...
n62 =  new note(2,2,eighth);

n63 =  new note(2,2,sixteenth);

n64 =  new note(1,2,sixteenth);

n65 =  new note(11,1,eighth);

n66 =  new note(3,2,sixteenth);

n67 =  new note(6,2,sixteenth);

n68 =  new note(8,2,sixteenth);

n69 =  new note(2,2,sixteenth);

n70 =  new note(6,2,sixteenth);

n71 =  new note(11,1,sixteenth);

n72 =  new note(1,2,sixteenth);

n73 =  new note(2,2,sixteenth);

n74 =  new note(1,2,sixteenth);

n75 =  new note(11,1,sixteenth);

seq6 = new stanza(new ArrayList<chord>() {{
add(chordOfNote(n62));
add(chordOfNote(n63));
add(chordOfNote(n64));
add(chordOfNote(n65));
...
m = new score(new ArrayList<stanza>() {{
add(seq1);
add(seq2);
add(seq3);
add(seq4);
